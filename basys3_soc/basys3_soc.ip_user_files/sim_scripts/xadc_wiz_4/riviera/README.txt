...
#
# Generated by export_simulation on Mon Aug 26 10:48:51 +0900 2024
#
################################################################################
...
'-reset_run' switch to the './xadc_wiz_4.sh' script.

./xadc_wiz_4.sh -reset_run
...
./xadc_wiz_4.sh -noclean_files

For more information on the script, please type './xadc_wiz_4.sh -help'.
