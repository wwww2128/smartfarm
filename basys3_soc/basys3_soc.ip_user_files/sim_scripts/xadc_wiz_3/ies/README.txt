...
#
# Generated by export_simulation on Sat Aug 24 15:39:12 +0900 2024
#
################################################################################
...
'-reset_run' switch to the './xadc_wiz_3.sh' script.

./xadc_wiz_3.sh -reset_run
...
./xadc_wiz_3.sh -noclean_files

For more information on the script, please type './xadc_wiz_3.sh -help'.
